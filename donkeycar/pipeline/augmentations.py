...
class Augmentations(object):
    ...
    def crop(cls, left, right, top, bottom, keep_size=False):
        ...
        """
        augmentation = iaa.Crop(px=(top, right, bottom, left), keep_size=keep_size)
        return augmentation
    ...
    def trapezoidal_mask(cls, lower_left, lower_right, upper_left, upper_right, min_y, max_y):
        ...
        augmentation = iaa.Lambda(
            func_images=_transform_images, func_keypoints=_transform_keypoints
        )
        return augmentation
